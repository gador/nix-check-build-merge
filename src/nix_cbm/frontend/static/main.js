$(document).ready(function () {
    ...
    function flash_alert(message, category, clean) {
        ...
        var htmlString = '<div class="alert alert-' + category + ' alert-dismissible">'
        htmlString += '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">'
    ...
    $("#reload-maintainer").on('click', function () {
        flash_alert("Reloading packages with " + $("#reload-maintainer").val() , "info");
        $.ajax({
